<template>
 ...
 <!-- <div class="houtaiLogin" >
            <router-link v-if="screenWidth>=610" to="./adminLogin">后台管理</router-link>
            <router-link v-else to="./adminLogin">后台</router-link>
          </div> -->
            ...
            <div class="navbar-menu-container">
              ...
              <div class="houtaiLogin" >
            <!-- <router-link v-if="screenWidth>=610" to="./AdminLogin">后台管理</router-link> -->
                <router-link to="/AdminLogin" class="loginA"></router-link>
              </div>
  ...
  watch:{
    screenWidth(val){
        ...
        if(!this.timer){
            ...
            this.timer = true
            let that = this
            //console.log(that.screenWidth,'111')
            setTimeout(function(){
                // 打印screenWidth变化的值
                console.log(that.screenWidth,'222')
                that.timer = false
            },400)
        }
    }
...
.navbar-right-container
  ...
  .loginA
    &:before
      ...
      width: 25px
      height: 25px
      background: url('../../static/images/icon1.png') -180px -160px
      background-size: 240px 107px
      transition: none                 
</style>
